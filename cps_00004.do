...
quietly infix                  ///
  ...
  int     ind90ly     131-133  ///
  int     occ10ly     134-137  ///
  byte    classwly    138-139  ///
  double  incwage     140-147  ///
  double  inclongj    148-155  ///
  double  oincwage    156-163  ///
  byte    qinclong    164-164  ///
  byte    qinclongd   165-166  ///
  byte    qoincwage   167-167  ///
  byte    qoincwaged  168-169  ///
  byte    qincwage    170-170  ///
  double  dwwagec     171-174  ///
  byte    jtyearago   175-176  ///
  int     jtind       177-180  ///
  int     jtind1990   181-183  ///
  int     jtocc       184-187  ///
  int     jtocc1990   188-190  ///
  double  hourwage    191-195  ///
  byte    union       196-196  ///
  byte    eligorg     197-197  ///
  byte    otpay       198-199  ///
  using `"cps_00004.dat"'
...
label define occ10ly_lbl 9999 `"Not in universe"', add
